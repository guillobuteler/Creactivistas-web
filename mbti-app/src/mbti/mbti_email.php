...
<body style="background-color: #FFFFFF;
	...
	<table style="background-color: #FFFFFF;
			...
			color: #666666;">
		<tr>
			<td><img src="http://actus.com.ar/mbti/header_zoom.jpg" width="800" /></td>
		</tr>
		<tr>
			<td>
				<?php if (!empty($email)): ?>
				...
				<?php else: ?>
					<p>(El usuario no proveyó una dirección de email.)</p>
				<?php endif; ?>
				...
				<table border=1>
					...
					<tr><th colspan="7" class="tipo2"><font color=red size=+2><?php echo $mbti ; ?></font></th></tr>
				</table>
				<p>
